...
import com.time_picker.adapter.WheelAdapter;
import com.time_picker.listener.OnItemSelectedListener;
import com.time_picker.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.dimen_20dp);//默认大小
