package com.download.core.domain;
...
import com.download.core.callback.DownloadListener;
...
public class DownloadInfo extends ClickBaseBean implements Serializable {
    ...
    public static final int TYPE_NORMOL = 100;
