package com.yongliang.lib_launch.launch.launchstarter.utils;
...
public class DispatcherExecutor {
    ...
    private static final DispatcherExecutor.DefaultThreadFactory sThreadFactory = new DispatcherExecutor.DefaultThreadFactory();
