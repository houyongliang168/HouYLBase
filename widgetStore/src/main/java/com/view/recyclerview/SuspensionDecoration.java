...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private Rect mBounds, bgBounds;//用于存放测量文字Rect
    ...
    private static int COLOR_LINE = Color.parseColor("#eeeeee");
    private static int COLOR_BG = Color.parseColor("#eeeeee");
    private static int mTitleFontSize;//title字体大小
    private static int mTitleMarginLeft;//title字体大小
    ...
    public SuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        ...
        mTitleMarginLeft = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics());
        mPaint.setTextSize(mTitleFontSize);
        mPaint.setAntiAlias(true);
        mInflater = LayoutInflater.from(context);
//        itemHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 35, context.getResources().getDisplayMetrics());
    }
...
//    public SuspensionDecoration setDecorationHeight(int itemHeight) {
//        this.mTitleHeight = itemHeight;
//        return this;
//    }
    ...
    public SuspensionDecoration setTitleMarginLeft(int marginLeft) {
        mTitleMarginLeft = marginLeft;
        return this;
    }
    public SuspensionDecoration setColorBg(int colorBg) {
        COLOR_BG = colorBg;
        return this;
    }
    public SuspensionDecoration setColorLine(int colorLine) {
...
//        itemHeight=child.getBottom()-child.getTop();
      /* 增加部分*/
//        mPaint.setColor(Color.WHITE);
//        c.drawRect(left, (child.getTop() - params.topMargin - itemHeight), right, child.getTop() - params.topMargin, mPaint);
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft()+mTitleMarginLeft, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
        mPaint.setStrokeWidth(2.5f);
//        mPaint.setColor(COLOR_LINE);
//        c.drawLine(child.getPaddingLeft() + 20, child.getTop() - params.topMargin, right, child.getTop() - params.topMargin, mPaint);
    }
