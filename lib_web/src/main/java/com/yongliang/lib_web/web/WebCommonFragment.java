package com.yongliang.lib_web.web;
...
import com.yongliang.lib_web.web.js.IJsInterface;
import com.yongliang.lib_web.web.js.TXXJSInterface;
...
import com.yongliang.lib_web.web.urlchecker.UrlCheckSdkManager;
import com.yongliang.lib_web.web.urlchecker.function.TelCheckFunction;
import com.yongliang.lib_web.web.util.H5TitleUtil;
import com.yongliang.lib_web.web.util.StatusBarUtil;
...
public class WebCommonFragment extends CoreBaseMVVMFragment<WebFragmentCommonWebBinding, WebpageViewModel> implements IWebPageView {
    ...
    public void getArguments(Bundle bundle) {
        ...
        boolean back2Html5Single = bundle.getBoolean(ConstantUtils.BACK_2_H5_SINGLE, false);
        if (back2Html5) {
