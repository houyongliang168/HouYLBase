...
package com.yongliang.houylbase.utils.tabs;
...
public class TabLayout extends HorizontalScrollView {
  ...
  @NonNull public SlidingTabIndicator slidingTabIndicator;

  @NonNull
  public SlidingTabIndicator getSlidingTabIndicator() {
  ...
  public TabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    tabIconTintMode =
        parseTintMode(a.getInt(R.styleable.TabLayout_tabIconTintMode, -1), null);
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    // height
    final int idealHeight = Math.round(dpToPx(getContext(), getDefaultHeight()));
    ...
    private void updateTextAndIcon(
      ...
      if (iconView != null) {
        ...
        if (hasText && iconView.getVisibility() == VISIBLE) {
          ...
          iconMargin = (int) dpToPx(getContext(), DEFAULT_GAP_TEXT_ICON);
        }
        if (inlineLabel) {
  ...
  public class SlidingTabIndicator extends LinearLayout {
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
      ...
      if ((tabGravity == GRAVITY_CENTER) || mode == MODE_AUTO) {
        ...
        final int gutter = (int) dpToPx(getContext(), FIXED_WRAP_GUTTER_MIN);
        boolean remeasure = false;
