package common_weight.recy.demo1.baseView;
...
import common_weight.recy.demo1.base.BaseViewModel;
import common_weight.recy.demo1.base.IDataSection;
import common_weight.recy.demo1.base.IViewSection;
import common_weight.recy.demo1.base.ViewAttributes;
 ...
 */
public abstract class FragmentBaseSectionProduct<V extends ViewDataBinding, VM extends BaseProductModel> implements IViewSection, IDataSection, LifecycleOwner, ISectionLifecycleObserver {
...
//        mContext.get().getLifecycle().addObserver(new GenericLifecycleObserver () {
//            @Override
//            public void onStateChanged(@NonNull LifecycleOwner source, @NonNull Lifecycle.Event event) {
//                if (mLifecycleRegistry != null) {
//                    mLifecycleRegistry.handleLifecycleEvent(event);
...
//        mContext 不能为空 一般不会直接创建 无构造参数 ViewModel
        ...
        return  ViewModelProviders.of (mContext.get ()).get(cls);
    }
...
//    提供方法处理 属性  也可以处理 沉浸式
    ...
    public Context getContext() {
        return mContext != null ?(mContext.get()!=null?mContext.get().getActivity () : null):null;
    }
