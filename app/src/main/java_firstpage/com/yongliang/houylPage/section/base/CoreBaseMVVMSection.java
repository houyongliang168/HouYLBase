...
import mvvm.IBaseView;
import mvvm.MVVMBaseFragment;

/**
 * Created by HOUYL on 2018/10/30.
 */

public abstract class CoreBaseMVVMSection<V extends ViewDataBinding, VM extends BaseViewModel> extends MVVMBaseFragment implements IBaseView {
    /***
