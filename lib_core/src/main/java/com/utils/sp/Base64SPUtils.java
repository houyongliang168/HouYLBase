...
public class Base64SPUtils {

    private Base64SPUtils() {
    }

    private static class Bulid {
        private static final Base64SPUtils single = new Base64SPUtils();
    }

    public static Base64SPUtils getInstance() {
        return Base64SPUtils.Bulid.single;
    }
